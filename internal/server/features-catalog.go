...
var featureDefinitions = []featureDefinition{
	...
	{
		Key:         service.FeatureChatSharing,
		Name:        "Chat sharing",
		Description: "Publish immutable conversation snapshots to workspace members and let them copy independent chats.",
		Group:       "workspace",
		Parent:      service.FeatureChatWorkbench,
	},
	{
