...
// ParseWithTools is retained for source compatibility. Skills are Markdown
// documentation, so tool-looking headings and code fences remain in the body
// and are never interpreted as executable definitions.
