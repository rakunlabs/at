...
// StorerClose combines the ProviderStorer, APITokenStorer, WorkflowStorer, TriggerStorer, SkillStorer, VariableStorer and NodeConfigStorer interfaces with a Close method.
