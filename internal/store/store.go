...
// StorerClose combines the ProviderStorer, APITokenStorer, WorkflowStorer, WorkflowVersionStorer, TriggerStorer, SkillStorer, VariableStorer and NodeConfigStorer interfaces with a Close method.
