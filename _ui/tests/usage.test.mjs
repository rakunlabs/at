...
test('user and source filters reach all aggregates, including explicitly unattributed calls', async () => {
  const filter = { user_id: ['one', 'two', ''], source: ['chats', 'sessions', ''], provider: ['p'], from: '2026-09-01T00:00:00Z' };
