...
func run(ctx context.Context) error {
	...
	srv, err := server.New(ctx, cfg.Server, cfg.Gateway, cfg.Bots, providers, st, st, st, st, st, st, st, st, st, st, st, st, st, st, st, st, st, st, st, storeType, newProvider, cl, version)
	if err != nil {
